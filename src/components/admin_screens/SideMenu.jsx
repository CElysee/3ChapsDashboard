        ...
        <div className="side-menu__content h-full box bg-white/[0.95] rounded-none xl:rounded-xl z-20 relative w-[275px] duration-300 transition-[width] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] overflow-hidden flex flex-col">
          ...
          <div className="scrollable-ref w-full h-full z-20 px-5 overflow-y-auto overflow-x-hidden pb-3 [-webkit-mask-image:-webkit-linear-gradient(top,rgba(0,0,0,0),black_30px)] [&:-webkit-scrollbar]:w-0 [&:-webkit-scrollbar]:bg-transparent [&_.simplebar-content]:p-0 [&_.simplebar-track.simplebar-vertical]:w-[10px] [&_.simplebar-track.simplebar-vertical]:mr-0.5 [&_.simplebar-track.simplebar-vertical_.simplebar-scrollbar]:before:bg-slate-400/30">
            <ul className="scrollable">
              ...
              <li className="side-menu__divider">ORDERS</li>
              <li>
                <a href="echo-creative.html" className="side-menu__link ">
                  <i
                    ...
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Pending</div>
                  <div className="side-menu__link__badge">4</div>
                </a>
              </li>
              <li>
                <a href="#" className="side-menu__link ">
                  <i
                    ...
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Approved</div>
                  <div className="side-menu__link__badge">4</div>
                </a>
              </li>
              <li>
                <a href="#" className="side-menu__link ">
                  <i
                    ...
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Delivered</div>
                  <div className="side-menu__link__badge">4</div>
                </a>
              </li>
              <li>
                <a href="#" className="side-menu__link ">
                  <i
                    data-tw-merge=""
                    data-lucide="alarm-clock-off"
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Canceled</div>
                  <div className="side-menu__link__badge">4</div>
                </a>
              </li>
              <li className="side-menu__divider">FOOD</li>

              <li>
                <a href={'/admin/food_categories'} className="side-menu__link ">
                  <i
                    data-tw-merge=""
              ...
              <li>
                <a href={'/admin/food_ingredients'} className="side-menu__link ">
                  <i
                    data-tw-merge=""
                    data-lucide="cherry"
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Ingredients</div>
                </a>
              </li>
              <li>
                <a href={'/admin/food_modifiers'} className="side-menu__link ">
                  <i
                    data-tw-merge=""
                    data-lucide="plus-square"
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Modifiers</div>
                </a>
              </li>
              <li>
                <a href={'/admin/food_items'} className="side-menu__link ">
                  <i
                    data-tw-merge=""
                    data-lucide="cup-soda"
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Item</div>
                </a>
              </li>
              <li className="side-menu__divider">REPORT</li>
              <li>
                <a href="#" className="side-menu__link ">
                  <i
                    data-tw-merge=""
                    data-lucide="candlestick-chart"
                    className="stroke-[1] w-5 h-5 side-menu__link__icon"
                  ></i>
                  <div className="side-menu__link__title">Sales</div>
                  <div className="side-menu__link__badge">4</div>
                </a>
              </li>
            </ul>
